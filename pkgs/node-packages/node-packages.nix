...
let
  sources = {
    ...
    "aws-sdk-2.747.0" = {
      ...
      version = "2.747.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.747.0.tgz";
        sha512 = "JA2ygLXFw0tLjc6nlauH3wnc6haoPU023fJCZN01xrw22l+s4rRjVGxJmG83VrfCmq+lrqCv0kVwlzyxbixGhA==";
      };
    };
...
in
{
  aws-azure-login = nodeEnv.buildNodePackage {
    ...
    version = "2.2.4";
    src = fetchurl {
      url = "https://registry.npmjs.org/aws-azure-login/-/aws-azure-login-2.2.4.tgz";
      sha512 = "JAwKeS4EOFYBn/KAImQ9LjIh2iuwtlacneGWvipQEa2YA8ZkRHHrOz7/HfYTW97T3SdClF+B2evTF/KftHHJ/g==";
    };
    dependencies = [
